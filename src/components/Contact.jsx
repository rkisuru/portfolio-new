    ...
    <div className="p-4 lg:3/4" id="contact">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className={
            'mb-8 w-full rounded border border-stone-50/30 bg-stone-200 px-4 py-2 text-sm font-semibold text-stone-900 hover:bg-stone-300 ${ isSending ? "cursor-not-allowed opacity-50" : "" }'
          }
          disabled={isSending}
        >
